        ...
        <form class="auth-form" action="process_signup.php" method="POST">
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="firstName" name="firstName" placeholder="First Name"
                    required maxlength="50" value="<?php echo isset($_SESSION['signup_data']['firstName']) ? htmlspecialchars($_SESSION['signup_data']['firstName']) : ''; ?>">
                <label for="firstName">First Name</label>
            </div>

            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="middleName" name="middleName" placeholder="Middle Name"
                    maxlength="50" value="<?php echo isset($_SESSION['signup_data']['middleName']) ? htmlspecialchars($_SESSION['signup_data']['middleName']) : ''; ?>">
                <label for="middleName">Middle Name (Optional)</label>
            </div>

            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="lastName" name="lastName" placeholder="Last Name"
                    required maxlength="50" value="<?php echo isset($_SESSION['signup_data']['lastName']) ? htmlspecialchars($_SESSION['signup_data']['lastName']) : ''; ?>">
                <label for="lastName">Last Name</label>
            </div>

            <div class="form-floating mb-3">
                <input type="email" class="form-control" id="email" name="email" placeholder="name@example.com"
                    required maxlength="100" value="<?php echo isset($_SESSION['signup_data']['email']) ? htmlspecialchars($_SESSION['signup_data']['email']) : ''; ?>">
            ...
            <div class="form-floating mb-3">
                <input type="checkbox" name="terms" required id="terms">By clicking "Sign
                Up,"you confirm that you have read, understood,
                and agreed to these <a href="terms.php">terms and conditions</a> .
            </div>
